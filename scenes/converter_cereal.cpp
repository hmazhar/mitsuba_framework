...
int main(int argc, char* argv[]) {
    ...
    if (argc == 4) {
        ...
        MarchingCubesToMesh(position, .016 * 2, output_mesh_ss.str(), chrono::real3(-10, -10, -10), chrono::real3(10, 10, 10), 0.000001);
        //data_document.AddShape("fluid", ChVector<>(1), ChVector<>(0), QUNIT);
    }
    data_document.AddShape("bowl", ChVector<>(1), ChVector<>(0), QUNIT);
