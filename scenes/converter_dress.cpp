...
int main(int argc, char* argv[]) {
  ...
  //
  //
  data_document.AddShape("cube", ChVector<>(0.147, 0.01, 0.147),
                         ChVector<>(0, 0.6958, -1.22465e-18),
                         ChQuaternion<>(6.12323e-17, 1, 0, 0));
  //  data_document.AddShape("cube", ChVector<>(0.01, 0.1724, 0.147),
  //  ChVector<>(-0.137, 0.5334, 1.86636e-17),
  //                         ChQuaternion<>(6.12323e-17, 1, 0, 0));
  data_document.AddShape("cube", ChVector<>(0.01, 0.1724, 0.147),
                         ChVector<>(0.137, 0.5334, 1.86636e-17),
                         ChQuaternion<>(6.12323e-17, 1, 0, 0));
  data_document.AddShape("cube", ChVector<>(0.147, 0.1724, 0.01),
                         ChVector<>(0, 0.5334, 0.137),
                         ChQuaternion<>(6.12323e-17, 1, 0, 0));
  data_document.AddShape("cube", ChVector<>(0.147, 0.1724, 0.01),
                         ChVector<>(0, 0.5334, -0.137),
                         ChQuaternion<>(6.12323e-17, 1, 0, 0));
  //  data_document.AddShape("cube", ChVector<>(0.635, 0.01, 0.635),
  //  ChVector<>(0.587803, -0.0635, 3.88825e-17),
  //                         ChQuaternion<>(5.65713e-17, 0.92388, -0.382683,
  //                         2.34326e-17));
  //  data_document.AddShape("cube", ChVector<>(0.635, 0.01, 0.635),
  //  ChVector<>(-0.587803, -0.0635, 3.88825e-17),
  //                         ChQuaternion<>(5.65713e-17, 0.92388, 0.382683,
  ...
  for (int i = 0; i < 40760; i++) {
    ...
    if (data_stream.fail() == false) {
      ...
      //      ofile_rings << pos.x << " " << pos.y << " " << pos.z << " " <<
      //      rot.e0 << " " << rot.e1 << " " << rot.e2 <<
      //      " "
      //                  << rot.e3 << std::endl;
    }
  }
